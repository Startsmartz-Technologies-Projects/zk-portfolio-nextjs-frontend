// Concerns (group/sister-company profiles) data — extracted from
// concern-detail-page-content.tsx so it can be consumed as plain data (the public
// component + the backend seed) without the client component. Shapes verbatim.
...
export { BASE_CONCERN, CONCERNS, RELATED_CONCERNS, DEFAULT_CONCERN_ID }
